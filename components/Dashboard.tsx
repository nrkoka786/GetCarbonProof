...
export const Dashboard: React.FC<DashboardProps> = ({ results, isProcessing, isSample, onAuthRequired, onSignInRequired }) => {
  ...
  const downloadSummaryPDF = async () => {
    ...
    try {
      ...
      const captureSection = async (el: Element, scale = 2.0) => {
        return await html2canvas(el as HTMLElement, {
          ...
          onclone: (clonedDoc) => {
            ...
            // SURGICAL RESTORATION: Explicitly target and force visibility for extraction page references
            ...
            auditLedgerRows.forEach(row => {
              ...
              subtitles.forEach(sub => {
                ...
                subEl.style.color = '#94a3b8'; // Restored slate-400 color for legibility
              });
            });
          }
        });
      ...
      doc.text('REPORT GENERATED BY GETCARBONPROOF', 20, 6); // ADDED: Master branding at top of Page 1
      ...
      doc.setFontSize(4);
      doc.setTextColor(148, 163, 184);
      doc.text('REPORT GENERATED BY GETCARBONPROOF', 20, 6); // ADDED: Master branding at top of Page 2
