...
export const Dashboard: React.FC<DashboardProps> = ({ results, isProcessing, isSample, onAuthRequired, onSignInRequired, onBack }) => {
  ...
  const downloadSummaryPDF = async () => {
    ...
    try {
          ...
          onclone: (clonedDoc) => {
            ...
            auditLedgerRows.forEach(row => {
               ...
               pageRefs.forEach(ref => {
                  ...
                  refEl.style.setProperty('display', 'block', 'important');
                  refEl.style.setProperty('visibility', 'visible', 'important');
                  refEl.style.setProperty('opacity', '1', 'important');
      ...
      doc.text('REPORT GENERATED BY GETCARBONPROOF', 20, 6);
